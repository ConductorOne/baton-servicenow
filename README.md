...
- `cmn_rota_member` - On-call schedule membership (synced; membership is provisioned via the `on_call_add_member`/`on_call_remove_member` action tables rather than by writing this table directly)
